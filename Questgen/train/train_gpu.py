...
args_dict = dict(
    ...
    model_name_or_path='/var/task/t5-base',
    tokenizer_name_or_path='/var/task/t5-base',
    max_seq_length=256,
    learning_rate=3e-4,
    weight_decay=0.0,
    adam_epsilon=1e-8,
...
tokenizer = T5Tokenizer.from_pretrained('/var/task/t5-base', local_files_only=True)
